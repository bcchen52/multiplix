# Generated by Django 4.1 on 2024-08-11 23:56
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('qpm', models.DecimalField(blank=True, decimal_places=2, default=0, max_digits=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('display_name', models.CharField(default='display_name', max_length=32)),
                ('length', models.IntegerField(default=50)),
                ('min_value', models.DecimalField(decimal_places=2, default=0, max_digits=10)),
                ('tests', models.ManyToManyField(related_name='leaderboard', to='multiplix.test')),
            ],
        ),
    ]
